        ...
        <section id="resume" className="resume">
            ...
            <ul>
                <li>
                    ...
                    <p className="title">Front-End Developer at <a target="_blank" href="https://www.webistry.com/">Webistry</a></p>
                </li>
                <li>
                    <p className="duration">Oct 2022 — Sep 2023</p>
                    <p className="title">Solutions Architect at <a target="_blank" href="https://safelinegroup.ca/">Safeline Group</a></p>
                </li>
                <li>
                    <p className="duration">Aug 2021 — Sep 2022</p>
                    <p className="title">Technology Specialist at <a target="_blank" href="https://www.optrust.com/Home/default.asp">OPTrust</a></p>
                </li>
                <li>
                    <p className="duration">Mar 2020 — Aug 2021</p>
                    <p className="title">Front-End Developer at <a target="_blank" href="https://www.beapartof.com/">Be A Part Of</a></p>
                </li>
                <li>
                    <p className="duration">Jan 2019 — Feb 2020</p>
                    <p className="title">Pursued web development at <a target="_blank" href="https://junocollege.com/">Juno College of Technology</a></p>
                </li>
                <li>
